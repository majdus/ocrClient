...
import (
	...
	"ocrClient/route/middleware/acl"
	"ocrClient/route/middleware/logrequest"
	"ocrClient/route/middleware/pprofhandler"
	"ocrClient/session"

	hr "ocrClient/route/middleware/httprouterwrapper"
...
func routes() *httprouter.Router {
	...
	r.GET("/", hr.Handler(alice.
		New().
		ThenFunc(controller.HomeGET)))

	r.POST("/", hr.Handler(alice.
		New().
		ThenFunc(controller.HomePOST)))
